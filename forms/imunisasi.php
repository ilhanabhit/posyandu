                                    ...
                                    <div class="modal-content">
                                        <form id="tambah-imunisasi-form" method="post" action="tambahImunisasi.php">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    <label for="jenis_imunisasi" style="font-size: 15px;">Jenis Imunisasi</label>
                                                    <select id="jenis_imunisasi_tambah" name="jenis_imunisasi" style="font-size: 13px;" class="form-control" required style="border-color: black; border: 1px solid black;">
                                                        <!-- Options will be dynamically added here using JavaScript -->
                                                    </select>
                                                </div>

                                                <script>
                                                    // Get the select element for "Tambah Data" modal
                                                    var jenisImunisasiSelectTambah = document.getElementById("jenis_imunisasi_tambah");
                                                    ...
                                                    // Populate the select element with options for "Tambah Data" modal
                                                    for (var i = 0; i < optionsTambah.length; i++) {
                                                        var optionTambah = document.createElement("option");
                                                        optionTambah.text = optionsTambah[i];
                                                        jenisImunisasiSelectTambah.add(optionTambah);
                                                    }
                                                </script>
